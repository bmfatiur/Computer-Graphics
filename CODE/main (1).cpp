...
// Define the clipping window (20, 20, 80, 80)
double x_min = 20, y_min = 20, x_max = 80, y_max = 80;
...
vector<Point> sutherlandHodgmanClip(const vector<Point>& polygon) {
    ...
    clippedPolygon = clipEdge(clippedPolygon, x_min, y_min, true, true);   // Clip against left edge
    clippedPolygon = clipEdge(clippedPolygon, x_max, y_max, true, false);  // Clip against right edge
    clippedPolygon = clipEdge(clippedPolygon, y_min, x_min, false, true);  // Clip against bottom edge
    clippedPolygon = clipEdge(clippedPolygon, y_max, x_max, false, false); // Clip against top edge
